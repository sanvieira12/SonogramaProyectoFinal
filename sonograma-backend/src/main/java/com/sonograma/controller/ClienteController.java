...
import com.sonograma.service.ClienteExcelImportService;
...
public class ClienteController {
    ...
    private final ClienteExcelImportService clienteExcelImportService;
    ...
    public ResponseEntity<ClienteImportResultDTO> importarExcel(
            @RequestParam MultipartFile file,
            @RequestParam(required = false) String hoja) {
        return ResponseEntity.ok(clienteExcelImportService.importar(file, hoja));
    }
}
